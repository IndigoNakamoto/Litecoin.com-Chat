...
def after_prechecks(state: RAGState) -> str:
    """Route live lookups off the RAG path. Used by tests."""
    ...
    if state.get("intent") == "lrk_metric":
        return "lrk_lookup"
